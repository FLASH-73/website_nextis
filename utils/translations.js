export const translations = {
    en: {
        ...
        hardware: {
            ...
            framingLine: "The same hardware we use to build the universal constructor.",
            ...
            whoDesc: "Independent robotics builders, PhD students collecting demonstration data, and anyone who wants to train manipulation policies without spending six months on hardware.",
            whoDescNote: "If you found this from the 3D-printed arm thread \u2014 the aluminium version is in production. Sign up to be notified.",
            ctaTitle: "Join the Kit Waitlist",
            ctaSubtitle: "First batch is limited. Leave your email and we'll contact you before public release.",
            openSourceTeaser: "Want to build your own? 3D-printable files coming soon.",
            namePlaceholder: "Your name (optional)",
            emailPlaceholder: "Email address",
            countryPlaceholder: "Shipping country (optional)",
            submit: "Reserve a Spot",
            formSuccess: "Request sent. We will be in touch.",
            socialProof: "47,000+ views in 24 hours on X. The build files are coming. Sign up to be first in line for the aluminium kit.",
    ...
    de: {
        ...
        hardware: {
            ...
            framingLine: "Die gleiche Hardware, mit der wir den universellen Konstruktor bauen.",
            ...
            whoDesc: "Unabhaengige Robotik-Entwickler, Doktoranden, die Demonstrationsdaten sammeln, und alle, die Manipulationsstrategien trainieren wollen, ohne sechs Monate an Hardware zu verbringen.",
            whoDescNote: "Falls Sie ueber den 3D-Druck-Arm-Thread hierher gefunden haben: Die Aluminium-Version ist in Produktion. Registrieren Sie sich, um benachrichtigt zu werden.",
            ctaTitle: "Kit-Warteliste beitreten",
            ctaSubtitle: "Die erste Charge ist begrenzt. Hinterlassen Sie Ihre E-Mail und wir kontaktieren Sie vor der oeffentlichen Veroeffentlichung.",
            openSourceTeaser: "Selbst bauen? 3D-druckbare Dateien kommen bald.",
            namePlaceholder: "Ihr Name (optional)",
            emailPlaceholder: "E-Mail-Adresse",
            countryPlaceholder: "Versandland (optional)",
            submit: "Platz reservieren",
            formSuccess: "Anfrage gesendet. Wir melden uns.",
            socialProof: "47.000+ Aufrufe in 24 Stunden auf X. Die Build-Dateien kommen. Registrieren Sie sich, um als Erste das Aluminium-Kit zu erhalten.",
